...
export const mockPosts = [
  {
    ...
    content: '새로운 트레일 러닝화를 신고 첫 러닝을 다녀왔어요! 착화감이 정말 좋네요. Contoso 제품은 역시 믿고 살 수 있어요. #러닝 #트레일러닝 #신발',
  ...
  {
    id: 2,
    userName: 'camp_master',
    content: '신형 텐트 첫 설치! 혼자서도 10분 만에 설치 완료했어요. 정말 편리하네요. 이번 주말 캠핑이 기대됩니다. #캠핑 #텐트 #아웃도어',
